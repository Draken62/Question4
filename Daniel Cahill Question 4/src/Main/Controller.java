...
import Model.LecturerAvail;
import Database.Database;

public class Controller {
    private Scanner keyboard;
    private LecturerAvail lecturerList;
    ...
    public Controller() {
        ...
        if (lecturerList == null) {
            lecturerList = new LecturerAvail(100);
        }
    ...
    public LecturerAvail load() {
        // Load database from file and returns it for implementation
        Database fs = new Database();
        return (LecturerAvail) fs.LoadFile("lecturer.dat");
    }
